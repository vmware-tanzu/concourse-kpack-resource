...
func (o *Out) Out(inDir string, src Source, params OutParams, env oc.Environment, log Logger) (oc.Version, oc.Metadata, error) {
	image, err := o.Clientset.KpackV1alpha1().Images(src.Namespace).Get(context.TODO(), src.Image, metav1.GetOptions{})
	...
	image, err = o.Clientset.KpackV1alpha1().Images(src.Namespace).Update(context.TODO(), image, metav1.UpdateOptions{})
	if err != nil {
		return nil, nil, err
	}
